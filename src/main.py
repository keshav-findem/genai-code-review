...
def main():
    ...
    openai_client = OpenAIClient(env_vars['OPENAI_MODEL'],
                                 ...
                                 env_vars['OPENAI_MAX_COMPLETION_TOKENS'])
...
def get_env_vars():
    ...
    variables = {
        ...
        'OPENAI_MAX_COMPLETION_TOKENS': (int, True),
        'MODE': (str, True),
        'LANGUAGE': (str, True),
...
def analyze_commit_files(github_client, openai_client, pr_id, commit, language, custom_prompt, include_regex, exclude_regex):
    ...
    review = openai_client.generate_response(create_review_prompt(combined_content,
                                                                  ...
                                                                  custom_prompt))
    if review:
        logging.info("Generated review length: %d characters", len(review))
    else:
        logging.warning("No review was generated by OpenAI")
